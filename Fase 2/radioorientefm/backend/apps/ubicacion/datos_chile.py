...
REGIONES_COMUNAS = {
    ...
    "Región de Coquimbo": [
        "La Serena", "Coquimbo", "Andacollo", "La Higuera", "Paiguano", "Vicuña", "Illapel", "Canela", "Los Vilos", "Salamanca",
    ...
    "Región del Maule": [
        "Talca", "ConsConsul", "Pelarco", "Pencahue", "Maule", "San Clemente", "San Rafael",
    ...
    "Región de La Araucanía": [
        ...
        "Angol", "Collipulli", "Curacautín", "Ercilla", "Lonquimay", "Los Sauces", "Lumaco", "Purén", "Renaico",
        "Traiguén", "Victoria"
    ],
    "Región de Los Ríos": [
